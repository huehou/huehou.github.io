...
$$
> [!hint]- Proof
> Diagonalise $A$ using unitary matrices, and by cyclic property ![[#^7524c4]], the unitary matrices will combine into a unit matrix $\um$, and we are left with just the sum of the eigenvalues. 
