...
> Hence, 
> $$
> \begin{align*} \bra{z} \rho_{\mathrm{out}}^{T_B} \ket{z} ={}& \bra{z} {\pqty{A \otimes B^*}} \rho^{T_B} {\pqty{A^\dagger \otimes B^T}} \ket{z} \\ \equiv{}& \bra{z'} \rho^{T_B} \ket{z'}\\ \geq{}& 0 \quad \forall \, z\,. \end{align*}  
> $$
